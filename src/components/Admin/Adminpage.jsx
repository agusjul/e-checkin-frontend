...
class ScanQR extends React.Component{
    ...
    async deleteAll(){
      await axios.delete("https://badung-dot-e-checkin-server-283807.et.r.appspot.com/api/visitors/delete", {
        headers : {
    ...
    async delete(id){
      await axios.delete(`https://badung-dot-e-checkin-server-283807.et.r.appspot.com/api/visitors/${id}/delete`, {
        headers : {
          Authorization : `bearer ${JSON.parse(localStorage.getItem("token")).token}`
        }
      })
    ...
    async componentDidMount(){
      ...
      const respon = await axios({
        method : "get",
        url : "https://badung-dot-e-checkin-server-283807.et.r.appspot.com/api/visitors",
        headers : {
          Authorization : `Bearer ${JSON.parse(localStorage.getItem("token")).token}`
        }
      })
